...
--First solution
-- for item in ipairs(prince_codes) do
--   if prince_codes[item].Page == page_input then
--     if prince_codes[item].Line == line_input then
--       if prince_codes[item].Word == word_input then
--         print("The code of combination is ".. prince_codes[item].Code)
--       end
--     end
--   end
-- end
...
--More Smart solution
for i, item in ipairs(prince_codes) do
  if item.Page == page_input and item.Line == line_input and item.Word == word_input then
    print("The code of combination is ".. item.Code)
  end
end
